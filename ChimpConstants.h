...
static const float
    ...
    DEFAULT_SCROLL_FACTOR_BACK = 0.1,  // background window position as a multiple of middle window position
    DEFAULT_SCROLL_FACTOR_FORE = 1.25; // foreground window position as a multiple of middle window position
